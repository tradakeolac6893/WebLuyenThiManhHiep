<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage/LayOutAdmin.Master" AutoEventWireup="true" CodeBehind="EditQLClass.aspx.cs" Inherits="LuyenThiHiep.Admin.QLy_Class.EditQLClass" %>
        ...
        <div class="but_list">
            <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                 <ul id="myTab" class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation"  class="active"><a href="/Admin/QLy_Class/EditQLClass.aspx" role="tab" >Chỉnh Sửa Lớp</a></li>
                  ...
                  <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                        <div class="tab-pane active" id="horizontal-form">
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-sm-1 control-label" style="padding-top: 10px">Chọn Lớp:</label>
                                    <div class="col-sm-3">
                                        <asp:DropDownList ID="selectRole" CssClass="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="selectRole_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                    ...
                                    <div class="col-sm-2">
                                        <asp:Button ID="btnEditClass" CssClass="btn btn-primary" runat="server" Text="Chỉnh Sửa Lớp" OnClick="btnEditClass_Click" />
                                    </div>
